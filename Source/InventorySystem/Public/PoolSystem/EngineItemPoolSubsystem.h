...
#include "EngineItemPoolSubsystem.generated.h"

/**
 * Engine subsystem for managing item object pooling across levels
 * Useful for items that need to persist between map changes
 */
UCLASS()
class INVENTORYSYSTEM_API UEngineItemPoolSubsystem : public UEngineSubsystem
{
	GENERATED_BODY()
